...
if (!stats) return <p className="p-6 text-center">Loading your garden... n</p>
return (
<main className="p-5 pb-24 bg-cream-50 min-h-screen">
<h1 className="font-heading text-3xl text-sage-700 mb-4">Your Garden n</h1>
<div className="grid grid-cols-2 gap-4">
<StatCard emoji="n" label="Total Balance" value={stats.balance} tone="gold" />
<StatCard emoji="n" label="Received this month" value={stats.monthIn} tone="sage" />
<StatCard emoji="n" label="Spent this month" value={stats.monthOut} tone="peach" />
<StatCard emoji="n" label="Left this month" value={stats.left} tone="blush" />
<StatCard emoji="n" label="Today's spend" value={stats.todaySpend} tone="peach" />
<StatCard emoji="n" label="Total saved" value={stats.totalSaved} tone="gold" />
</div>
</main>
)
}