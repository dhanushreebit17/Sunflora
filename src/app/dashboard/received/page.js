...
export default function ReceivedPage() {
  ...
  return (
    <main className="p-5 pb-24 bg-cream-50 min-h-screen">
      ...
      <a href="/money-in" className="fixed bottom-24 right-6 z-20 bg-gold-400 text-white w-14 h-14 rounded-full flex items-center justify-center text-2xl shadow-lg">+</a>
